...
<Card goR={goRight} goL={goLeft} veg={vegies}> 
...
<CardLeftNew goR={goRight} veg={vegies}> 
<Content> 
</Content>
</CardLeftNew>

<CardRightNew goL={goLeft} veg={vegies}> 
<Content> 
</Content>
</CardRightNew>

<CardLeft goR={goRight} goL={goLeft} veg={vegies}> 
<Content> 
</Content>
</CardLeft>

<CardRight  goL={goLeft} goR={goRight} veg={vegies}> 
<Content> 
</Content>
</CardRight>
...
animation: ${props => props.goR ? goRightAnimCenter : props.goL ? goLeftAnimCenter :'none'} 0.4s ease-in-out;
cursor:pointer;
:hover{
  background-size: 280%;
 }
...
backdrop-filter: blur(5px);
transition: background-size 0.3s;
animation: ${props => props.goR ? goRightAnim : props.goL ? goRightAnimNewOut : 'none'} 0.4s ease-in-out;
`;
...
width:260px;
opacity: 0;
animation: ${props => props.goR ? goRightAnimNew : 'none'} 0.4s ease-in-out;
`;
...
align-items: center;
backdrop-filter: blur(5px);
animation: ${props => props.goL ? goLeftAnim : props.goR ? goLeftAnimNewOut : 'none'} 0.4s ease-in-out;
`;
